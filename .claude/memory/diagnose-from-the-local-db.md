...
description: 排查 agent 行为先查 ~/.oph-autoresearch/oph-autoresearch.sqlite3，那里有每次工具调用的完整 args 与 outcome；截图和记忆都不够
metadata:
  node_type: memory
  type: project
---
...
只读打开 `~/.oph-autoresearch/oph-autoresearch.sqlite3`（bun:sqlite，
